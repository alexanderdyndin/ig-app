...
class VideoGalleryView @JvmOverloads constructor(
            ...
            CoroutineScope(Dispatchers.Main).launch {
                ...
                bindedService?.let {
                    urls.forEach {
                        ...
                        imageLoadingDelegate?.loadImageFromUrl(
                            it.preview,
                            playerView.previewForVideo
                        )
                        playerView.durationVideo.text =
    ...
    private fun setUpListener(
        service: IGMediaService.ServiceBinder,
        ...
        val listener = object : Player.EventListener {
            override fun onPlayWhenReadyChanged(playWhenReady: Boolean, reason: Int) {
                if (playWhenReady) {
                    ...
                    playerView.previewForVideo.gone()
                    service.setVideoPlayer(
                        videoPlayer, IGMediaService.MediaFile(false, video.id),
