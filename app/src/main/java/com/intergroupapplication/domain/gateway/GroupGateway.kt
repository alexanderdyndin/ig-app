...
interface GroupGateway {
    fun getGroupList(page: Int, searchFilter:String): Single<List<GroupEntity>>
    fun getSubscribedGroupList(page: Int, searchFilter:String): Single<List<GroupEntity>>
    fun getAdminGroupList(page: Int, searchFilter:String): Single<List<GroupEntity>>
