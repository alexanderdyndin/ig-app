 ...
 */
abstract class AbstractNotificationCreator<in Type>(private val context: Context,
                                                    private val notificationManager: NotificationManager?) : NotificationCreator<Type> {
    ...
    private fun createDefaultNotificationChanel(notificationCreatorOptions: NotificationCreatorOptions) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel(context.getString(R.string.notification_channel_id), notificationCreatorOptions.channelName,
