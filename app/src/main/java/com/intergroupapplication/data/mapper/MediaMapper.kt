...
class MediaMapper @Inject constructor() {
    ...
    fun mapToDto(from: FileRequestEntity): FileRequestModel =
            FileRequestModel(from.file, from.description.orEmpty(), from.title.orEmpty(), from.preview)
    ...
    fun mapToDomainEntity(from: FileRequestModel): FileRequestEntity =
            FileRequestEntity(from.file, from.description.orEmpty(), from.title.orEmpty(),from.preview)
    ...
    fun mapToDto(from: FileEntity): ImageVideoModel {
        return ImageVideoModel(from.id, from.file, from.isActive, from.description, from.title, from.post, from.owner, from.preview)
    }

    fun mapToDomainEntity(from: ImageVideoModel): FileEntity {
        return FileEntity(from.id, from.file, from.isActive, from.description, from.title, from.post, from.owner,from.preview?:"")
    }
